...
const PERM_LABELS: Record<string, { label: string; descripcion: string }> = {
  ...
  EMITIR_COMPROBANTE:       { label: 'Emitir boletas y facturas',        descripcion: 'Emitir comprobantes electrónicos a SUNAT' },
...
const PERMISSION_GROUPS: { label: string; color: string; icon: React.ReactNode; codes: string[] }[] = [
  ...
  { label: 'Facturación',      color: 'indigo',  icon: <FileText     size={15} />, codes: ['VER_FACTURACION','EMITIR_COMPROBANTE','VER_COMPROBANTE','ANULAR_COMPROBANTE'] },
